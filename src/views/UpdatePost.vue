									...
									<div v-if="userLoggedIn">
										...
										<form @submit.prevent="handleSubmit">
											...
											<div class="d-flex justify-content-center">
												<button type="submit"
												class="btn btn-success btn-block btn-lg gradient-custom-4 text-body mx-3">Update</button>
												<button  @click="cancel()"
...
export default {  
	...
	methods: {
		...
		async getPost(){
			this.post = this.$store.getters['microposts/getMicropost'](this.$route.params.id)
		}
